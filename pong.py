...
def game():
    ...
    while True:
        ...
        player_2_rect = pygame.Rect(
            player_2, player_2_y, raquete_largura, raquete_altura
        )
        ...
        pygame.draw.rect(
            tela, BRANCO, (player1_x, player1_y, raquete_largura, raquete_altura)
        )
        pygame.draw.rect(
            tela, BRANCO, (player_2, player_2_y, raquete_largura, raquete_altura)
        )
        ...
        score_text = font_score.render(
            f"{score_player1} - {score_player2}", True, BRANCO
        )
